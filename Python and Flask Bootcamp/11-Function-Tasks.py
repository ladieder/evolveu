...
print(compare_len("hello", "hi"))
print(compare_len("hi","hello"))
print(compare_len("hi", "hi"))
...
def sum_or_max(mylist):
    if len(mylist)%2==0:    
        return "sum: " + str(sum(mylist))
    else:
        return "max: " + str(max(mylist))
